...
export const typeProfiles: Record<string, {
    name: string;
    icon: string;
    color: string;
    tagline: string;
...
export function calculateScores(answers: (string | null)[]): Record<string, number> {
    const scores: Record<string, number> = { tiger: 0, peacock: 0, koala: 0, owl: 0, chameleon: 0 };
